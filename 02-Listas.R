...
lista2 <- list(elemento1=3.5, elemento2=c(1.2,3.5))
lista2
...
# Verificas o comprimento da lista
length(lista1)


# Podemos extrair um elemento especifico dentro de cada nivel
lista1$caracteres[2]
...
# Transdormando um vetor em lista
v = c(1:3)
v
l = as.list(v)
l
